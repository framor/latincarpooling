...
(
    id_usuario integer
) returning int, char(50), char(50), char(20), varchar(255), varchar(255), char(25), char(25), char(25), char(1), boolean, varchar(100), int, char(4), char(20), char(11), char(25), boolean, int, int, boolean, smallint, smallint;
